    ...
    function(e, t, n) {
      ...
      var h = function(e) {
        ...
        x = function(e) {
          ...
          e.vertical
            ? (n = r * e.slideHeight[e.currentSlide ? e.currentSlide - 1 : 0])
            : (t = C(e) * e.slideWidth);
        ...
        M = function(e) {
          ...
          if (
            ...
            if (
              ((m = i + j(e)),
              (r = w && w.childNodes[m]),
              (n = r ? -1 * r.offsetLeft : 0),
              !0 === l)
            ) {
              (m = a ? i + j(e) : i), (r = w && w.children[m]);
              for (var S = (n = 0); S < m; S++)
                n -= w && w.children[S] && w.children[S].offsetWidth;
            ...
            return (
              ...
              be(ye(n), "updateState", function(e, t, r) {
                var o = (function(e) {
                  ...
                  var l = [];
                  new Array(n).fill("").map(function(t, n) {
                    l[n] =
                      s.a.findDOMNode(e.listRef) &&
                      w(
                        s.a
                          .findDOMNode(e.listRef)
                          .querySelector('[data-index="'.concat(n, '"]'))
                      );
                  });
                  var c =
                  ...
                  e.rtl &&
                    ...
                    (c = n - 1 - e.initialSlide);
                  var u = l[c],
                    d = e.lazyLoadedList || [],
                    p = h({ currentSlide: c, lazyLoadedList: d });
                  d.concat(p);
                  var f = {
                    slideCount: n,
                    slideWidth: t,
