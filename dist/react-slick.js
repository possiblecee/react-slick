...
*/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        var initializedState = function initializedState(spec) {
          ...
          var slideHeight = [];
          new Array(slideCount).fill("").map(function(v, i) {
            slideHeight[i] =
              react_dom__WEBPACK_IMPORTED_MODULE_1___default.a.findDOMNode(
                spec.listRef
              ) &&
              getHeight(
                react_dom__WEBPACK_IMPORTED_MODULE_1___default.a
                  ...
                  .querySelector('[data-index="'.concat(i, '"]'))
              );
          });
          var currentSlide =
          ...
          var listHeight = slideHeight[currentSlide]; // TODO only working when slidesToShow === 1
        ...
        var getTrackLeft = function getTrackLeft(spec) {
          ...
          var slideIndex = spec.slideIndex,
            ...
            slideHeightArray = spec.slideHeight,
            fade = spec.fade,
            vertical = spec.vertical;
          var slideOffset = 0;
          var targetLeft;
          ...
          if (!vertical) {
            ...
            targetLeft = 0;
            new Array(slideIndex).fill("").map(function(v, i) {
              return (targetLeft -= slideHeightArray[i]);
            });
          }
